...
#include <fcntl.h>     // Để sử dụng hàm open và các hằng số như O_WRONLY
#include <stdlib.h>    // Để sử dụng hàm exit và hằng số EXIT_FAILURE
#include <unistd.h>    // Để sử dụng hàm write
#include <string.h>    // Để sử dụng hàm strle
